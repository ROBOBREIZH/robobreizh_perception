...
def array_to_image(arr):
    import numpy as np
    # need to return torch values to avoid python freeing memory
...
def detect_image(net, meta, im, thresh=.5, hier_thresh=.5, nms=.45, debug= False):
    ...
    #dets = get_network_boxes(net, im.shape[1], im.shape[0], thresh, hier_thresh, None, 0, pnum, letter_box) # OpenCV
...
def performDetect(imagePath="data/dog.jpg", thresh= 0.25, configPath = "./cfg/yolov3.cfg", weightPath = "yolov3.weights", metaPath= "./cfg/coco.data", showImage= True, makeImageOnly = False, initOnly= False):
    ...
    print("image:", imagePath.encode("ascii"))
...
def main():
    # print(performDetect())
    print(performDetect(imagePath="./data/test.jpg", thresh=0.25, configPath="./data/pan.cfg",
                        weightPath="./data/pan_optimized_last.weights", metaPath="./data/data.data"))
